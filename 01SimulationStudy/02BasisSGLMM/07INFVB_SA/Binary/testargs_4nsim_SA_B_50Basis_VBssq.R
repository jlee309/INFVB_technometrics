...
file_name3 <- paste0("../../03INFVB_ParallelComputing/Binary/50Basis_B_phi", phiselect, "_Gen25k_", sim, "_VBssqParallel.RData")
...
save(cov_sample_eta_trainingdata_VB_all, cov_sample_eta_testdata_VB_all,
     mu_sample_est_VB, mu_sample_pred_VB,
     file = paste0("SA_50Basis_B_phi", phiselect, "_Gen25k_", sim, "_VBssqParallel.RData"))
#   }
# }

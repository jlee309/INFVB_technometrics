################################################################################
################################################################################
# 11202024 Summary for Binary 50 Basis functions
################################################################################
################################################################################
rm(list=ls())
...
ggplot(df_prob_testdata)+
  geom_point(aes(x=df_prob_testdata[,2] , y=df_prob_testdata[,3] , color=prob_testdata), shape=7)+
...
ggplot(df_exp_prediction)+
  geom_point(aes(x=df_exp_prediction[,2] , y=df_exp_prediction[,3] , color=exp_prediction_VB), shape=7)+
  scale_color_gradientn(colours = rainbow(3))+
...
ggplot(df_exp_prediction_VB)+
  geom_point(aes(x=df_exp_prediction_VB[,2] , y=df_exp_prediction_VB[,3] , color=exp_prediction_VB), shape=7)+
  scale_color_gradientn(colours = rainbow(3))+
...
ggplot(df_exp_prediction_MFVB)+
  geom_point(aes(x=df_exp_prediction_MFVB[,2] , y=df_exp_prediction_MFVB[,3] , color=exp_prediction_VB), shape=7)+
  scale_color_gradientn(colours = rainbow(3))+
  #labs(title="Probability - VB", y="", x="")+
  theme(legend.position = "right",
        legend.title=element_blank() ) +

################################################################################
################################################################################
# INFVB for Count Data using 20 Eigen Basis functions
################################################################################
################################################################################
rm(list=ls())
...
################################################################################
################################################################################
numofbasis<-20 # Choose the first 200 Eigen basis functions
...
save(parameterMatrix , deltaMatrix , ptFinal , 
     ...
     file = paste0("Basis_C_phi",phiselect,"_Gen25k_",sim,"_MCMC.RData"))
################################################################################
################################################################################
# Summary CRPS for Poisson Basis
################################################################################
################################################################################
rm(list=ls())
getwd()
...
#phi1 50 Simulations
rm(list=ls())
load("50Basis_C_phi1_Gen25k_CRPS.RData")
...
################################################################################
#phi2 50 Simulations
load("50Basis_C_phi2_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)
...
################################################################################
#phi3 50 Simulations
load("50Basis_C_phi3_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)
...
################################################################################
#phi4 50 Simulations
load("50Basis_C_phi4_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)
...
#phi1 50 Simulations
rm(list=ls())
load("Basis_C_phi1_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)
...
################################################################################
#phi2 50 Simulations
load("Basis_C_phi2_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)
...
################################################################################
#phi3 50 Simulations
load("Basis_C_phi3_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)
...
################################################################################
#phi4 50 Simulations
load("Basis_C_phi4_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)
...
#phi1 50 Simulations
rm(list=ls())
load("100Basis_C_phi1_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)
...
################################################################################
#phi2 50 Simulations
load("100Basis_C_phi2_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)
...
################################################################################
#phi3 50 Simulations
load("100Basis_C_phi3_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)
...
#phi4 50 Simulations
rm(list=ls())
load("100Basis_C_phi4_Gen25k_CRPS.RData")
length(crpsTotal_MCMC_mean_vector)
length(crpsTotal_HMFVB_mean_vector)
length(crpsTotal_VBssq_mean_vector)
length(crpsTotal_INLA_mean_vector)

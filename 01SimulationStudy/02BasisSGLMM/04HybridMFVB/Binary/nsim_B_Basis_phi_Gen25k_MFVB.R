################################################################################
################################################################################
# HMFVB for Binary Data using 20 Eigen Basis functions 
...
################################################################################
################################################################################
numofbasis<-20 # Choose the first 20 Eigen basis functions
...
save(exp_prediction_MFVB , exp_RMSPE_MFVB , aucVal_MFVB ,MFVB_ptFinal , 
    ...
    file=paste0("Basis_B_phi",phiselect,"_Gen25k_",sim,"_HMFVB.RData")) 
  }
}

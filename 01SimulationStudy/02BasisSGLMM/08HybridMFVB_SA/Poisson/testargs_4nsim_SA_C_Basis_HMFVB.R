...
################################################################################
# 11032024 
# Count Data - Basis function MFVB Eta sampling method
################################################################################
################################################################################
rm(list=ls())
...
file_name3 <-paste0("../../04HybridMFVB/Poisson/Basis_C_phi",phiselect,"_Gen25k_",sim,"_HMFVB.RData")
...
save(MFVB_mean_SA_Est,cov_sample_eta_trainingdata_MFVB, 
     MFVB_mean_SA_Pred,cov_sample_eta_testdata_MFVB, 
     file=paste0("SA_Basis_C_phi",phiselect,"_Gen25k_",sim,"_HMFVB.RData")) 

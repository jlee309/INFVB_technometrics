################################################################################
# 11032024 
# Basis function HMFVB Eta sampling method_100bases
################################################################################
################################################################################
rm(list=ls())
...
file_name3 <- paste0("../../04HybridMFVB/Binary/100Basis_B_phi", phiselect, "_Gen25k_", sim, "_HMFVB.RData")
load(file_name1)
load(file_name2)
load(file_name3)
...
save(MFVB_mean_SA_Est,cov_sample_eta_trainingdata_MFVB, 
     ...
     file=paste0("SA_100Basis_B_phi",phiselect,"_Gen25k_",sim,"_HMFVB.RData")) 
#   }
# }
